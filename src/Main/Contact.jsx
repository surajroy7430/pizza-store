...
const Contact = () => {
  ...
  const handleSubmit = async (values, { setSubmitting, resetForm }) => {
    try {
      ...
      localStorage.setItem('pizzaStoreFeedbacks', JSON.stringify(updatedFeedbacks));
    ...
    <>
      <Container className="my-5">
        ...
        <Row className="justify-content-center">
          <Col md={8}>
            <h1>Contact Us</h1>
            <p>We'd love to hear from you! Please fill out the form below to send us your feedback or ask any questions.</p>
            ...
            >
              {({ errors, touched, isSubmitting }) => (
                <FormikForm>
                  <Row className="mb-3">
                    <Col>
                      <Field name="name" className="form-control" placeholder="Your Name" />
                  ...
                  <Row className="mb-3">
                    <Col>
                      <Field name="message" as="textarea" className="form-control" rows="4" placeholder="Your Message" />
            ...
            <Alert variant="info" className="mt-4">
              We respect your privacy and will never share your personal information with others.
            </Alert>
