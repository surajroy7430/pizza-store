    ...
    <div className="terms-of-service">
      ...
      <details>
        ...
        <div className="terms-content">
          ...
          <p>
            Thank you for using Pizza Hallen. These Terms of Service are intended to make you aware of your legal rights and responsibilities with respect to your access to and use of the Pizza Hallen website at <a target='_blank' href="http://www.pizzahallen.com">www.pizzahallen.com</a> (the "Site") including but not limited to delivery of information via the website whether existing now or in the future that link to the Terms.
          </p>
          
          <h2>2. Changes to These Terms</h2>
          <p>
            Pizza Hallen reserves the right to make changes to these Terms at any time. If we make material changes to these Terms, we will notify you by email or by posting a notice on our Site prior to the effective date of the changes.
          </p>
