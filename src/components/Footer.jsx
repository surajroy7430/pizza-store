    ...
    <Container>
      <footer className="footer d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
        <div className="col-md-4 d-flex align-items-center justify-content-center justify-content-md-start">
          <Link
            to="https://github.com/surajroy7430/pizza-store"
            target="_blank"
          >
            <svg
          ...
          <span className="mb-md-0">© {new Date().getFullYear()} Pizza Hallen, Inc</span>
        </div>
        ...
        <ul className="nav col-md-4 justify-content-end list-unstyled d-flex">
          ...
          <li className="ms-3">
            <Link to="https://www.linkedin.com/in/suraj18r" target="_blank">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
